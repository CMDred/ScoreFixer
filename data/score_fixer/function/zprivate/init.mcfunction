...
# Scoreboards
scoreboard objectives add ScoreFixer.LeaveGame minecraft.custom:minecraft.leave_game
...
# Tellraw
tellraw @a ["",{text:"🔨 ScoreFixer >> ",color:"#E4B0F7"},"Installed ScoreFixer (v1.1.1)"]
