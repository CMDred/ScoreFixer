...
execute if score #ScoreFixer.EntryCount ScoreFixer matches 1.. run function score_fixer:zprivate/fixer/transfer_scores_2 with storage score_fixer:zprivate Temp.Objectives[-1]
