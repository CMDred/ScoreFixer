...
execute as @a unless score @s ScoreFixer matches 0 store success score #ScoreFixer.SomeoneJoined ScoreFixer run scoreboard players add #ScoreFixer.OnlinePlayerCount ScoreFixer 1
...
execute as @a unless score @s ScoreFixer matches 0 run function score_fixer:zprivate/fixer/join/main
